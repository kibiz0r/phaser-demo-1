...
export default class PhaserEnvironment extends NodeEnvironment {

  constructor(config: Config.ProjectConfig, options?: EnvironmentContext) {
    super(config);
    // this.global.document = document as any
    // this.global.window = window as any
    // this.global.window.Element = undefined as any
    this.global.navigator = { userAgent: 'node' } as any
    this.global.Image = Canvas.Image as any
    // this.global.XMLHttpRequest = FakeXMLHttpRequest as any
    // this.global.HTMLCanvasElement = window.HTMLCanvasElement
    // this.global.HTMLVideoElement = window.HTMLVideoElement
  }
